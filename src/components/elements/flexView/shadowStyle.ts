...
const shadowOpacity = (key: number): number => key || 0.14;
...
const shadowMapping: { [key: number]: ShadowStyleIOS } = {
  ...
  10: {
    ...
    shadowColor: "black",
    shadowOpacity: shadowOpacity(10),
  },
};
